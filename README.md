# 📊 Desafio de Projeto: Power BI com Parâmetros de Campo

## 📝 DESCRIÇÃO

Foi proposto utilizar o relatório do desafio do módulo anterior. Com esse contexto em mãos foi realizada a criação de pelo menos dois visuais considerando a criação de parâmetros.

---

## 🛠️ Instruções para o desenvolvimento
...
*   **Primeira visão:** parâmetro com base em categorias 🗂️
